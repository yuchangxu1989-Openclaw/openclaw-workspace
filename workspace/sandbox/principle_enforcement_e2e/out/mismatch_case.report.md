...
- Source: `/root/.openclaw/workspace-coder/sandbox/principle_enforcement_e2e/tests/mismatch_case.json`
- Intent: `principle_to_enforcement_e2e` (0.92)
- Final Status: **FAIL**
...
- ❌ `gate` status=`None` present=`False`
