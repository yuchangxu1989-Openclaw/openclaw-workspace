...
| PB-009 | easy | ✅ | 2ms | analysis.requested → parallel-analysis rule fires |
...
| PB-023 | medium | ✅ | 19962ms | user.message → IntentScanner triggered |
| PB-024 | medium | ✅ | 5604ms | conversation.new → intent scan triggered |
| PB-025 | medium | ✅ | 8403ms | chat.incoming → intent scan triggered |
| PB-026 | medium | ✅ | 0ms | dialog.started → intent scan triggered |
...
| PB-036 | medium | ✅ | 0ms | L3_INTENTSCANNER_ENABLED=false → no intent scanning |
