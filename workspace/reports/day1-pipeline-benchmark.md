...
|----|------|--------|----------|----------|
| PB-001 | easy | ✅ | 10ms | skill.created → matches 2+ ISC rules (anti-entropy, layered- |
...
| PB-005 | easy | ✅ | 4ms | isc.rule.created → anti-entropy + layered-decoupling rules f |
...
| PB-013 | easy | ✅ | 0ms | Deep-nested unknown → no match |
...
| PB-023 | medium | ✅ | 23813ms | user.message → IntentScanner triggered |
| PB-024 | medium | ✅ | 4477ms | conversation.new → intent scan triggered |
| PB-025 | medium | ✅ | 30005ms | chat.incoming → intent scan triggered |
| PB-026 | medium | ✅ | 1ms | dialog.started → intent scan triggered |
| PB-027 | easy | ✅ | 1ms | design.document.modified → 3 rules fire |
| PB-028 | easy | ✅ | 0ms | skill_renamed → N018 rename alignment rule fires |
| PB-029 | easy | ✅ | 0ms | workflow.requested → parallel-subagent rule fires |
