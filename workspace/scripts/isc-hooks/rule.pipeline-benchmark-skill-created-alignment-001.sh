#!/usr/bin/env bash
set -euo pipefail
RULE_ID="rule.pipeline-benchmark-skill-created-alignment-001"
ROOT="/root/.openclaw/workspace"
RULE_FILE="$ROOT/skills/isc-core/rules/rule.pipeline-benchmark-skill-created-alignment-001.json"
STATUS="pass"
