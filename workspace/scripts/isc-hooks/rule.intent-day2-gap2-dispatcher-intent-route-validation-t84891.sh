#!/usr/bin/env bash
set -euo pipefail
RULE_ID="rule.intent-day2-gap2-dispatcher-intent-route-validation-t84891"
RULE_FILE="skills/isc-core/rules/rule.intent-day2-gap2-dispatcher-intent-route-validation-t84891.json"
DETAIL="ok"
STATUS="pass"
if [ ! -f "$RULE_FILE" ]; then
  STATUS="fail"
