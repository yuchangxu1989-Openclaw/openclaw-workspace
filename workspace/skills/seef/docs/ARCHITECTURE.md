...
### 3.1 SEEF 七步骤映射到 DTO 事件总线

#### 3.1.1 事件总线架构

DTO 事件总线是系统的**核心枢纽**，所有跨层通信通过事件驱动：
...
| ISC-DTO 握手 | 100% | 每30分钟自动同步 |
| DTO 任务调度 | 100% | 声明式工作流自动执行 |
...
| 版本 | 时间 | 变更 |
|:-----|:-----|:-----|
| 4.0.0 | 2026-03-01 | 新增 ISC-DTO-SEEF-EvoMap 全链路自动化架构 |
| 3.0.0 | 2026-02-28 | 新增 DTO EventBus 集成，PDCA状态机 |
...
- `/skills/dto-core/SKILL.md` - DTO 调度中心文档
